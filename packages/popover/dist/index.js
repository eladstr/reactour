...
var Popover = (_a) => {
  ...
  const helperRect = (0, import_reactour_utils.useRect)(helperRef, refresher);
  ...
  const autoPosition = (coords, outX, outY) => {
    const positionsOrder = (0, import_reactour_utils.bestPositionOf)(
      available,
  ...
  const pos = (helperPosition) => {
    if (Array.isArray(helperPosition)) {
      const isOutX = (0, import_reactour_utils.isOutsideX)(helperPosition[0], windowWidth);
      const isOutY = (0, import_reactour_utils.isOutsideY)(helperPosition[1], windowHeight);
    ...
    const isHelperOutsideX = (0, import_reactour_utils.isOutsideX)(targetLeft + helperWidth, windowWidth);
    const isHelperOutsideY = (0, import_reactour_utils.isOutsideY)(
